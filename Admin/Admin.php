          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              elseif (isset($_GET['msg']) && $_GET['msg'] == 'error') {
                ...
                echo "<h3 class='card-title'>Admin <small>Registration</small></h3>";
                }
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" action="Admin/insert.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                ...
                <div class="card-footer">
                  ...
                  <input type="hidden" name="admin" value="insert">
                </div>
              </form>
            </div>
            <!-- /.card -->
