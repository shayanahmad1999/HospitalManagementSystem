        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" action="Bill/insert.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="form-group">
                    <label>Doctor Charge</label>
                    <input type="number" name="doctor" class="form-control" placeholder="Enter Money">
                  </div>
                  <div class="form-group">
                    <label>Room Charge</label>
                    <input type="number" name="room" class="form-control" placeholder="Enter Money">
                  </div>
                  <div class="form-group">
                    <label>Laboratory Charge</label>
                    <input type="number" name="laboratory" class="form-control" placeholder="Enter Money">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select name="patient" class="form-control">
                        ...
                        ?>
                        <option value="<?php echo $show['Patient_ID'] ?>"><?php echo $show['Patient_Name']; ?></option>
                        <?php } ?>
                    </select>
                  </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  ...
                  <input type="hidden" name="bill" value="insert">
                </div>
              </form>
            </div>
            <!-- /.card -->
