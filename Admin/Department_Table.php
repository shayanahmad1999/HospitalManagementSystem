...
{
  $search = $_GET['search'];
  $go = mysqli_query($connect,"select * from department where Department_Name like '%$search%'"); 
}
else{
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <a href="Department.php"><button class="btn btn-info"><i class="fas fa-address-book">Insertion</i></button></a>
              <a href="Department/DeleteAll.php"><button class="btn btn-danger"><i class="fas fa-trash">Delete All</i></button></a>  
              <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td><img src="uploads/<?php echo $show['Department_Photo']; ?>" class="img-thumbnail" width="10%"></td>
                    <td>
                      <?php if($show['Department_Status'] == 0){ ?>
                      <a href="Department_Table.php?id=<?php echo $show['Department_ID']; ?>&&st_id=<?php echo $show['Department_Status']; ?>"><button class="btn btn-danger"><i class="fas fa-times"></i></button></a>
                      <?php } else{ ?>
                        <a href="Department_Table.php?id=<?php echo $show['Department_ID']; ?>&&st_id=<?php echo $show['Department_Status']; ?>"><button class="btn btn-success"><i class="fas fa-check"></i></button></a>
                        <a href="Department_Edit.php?id=<?php echo $show['Department_ID']; ?>"><button class="btn btn-info"><i class="fas fa-edit"></i></button></a>
                        <a href="Department/delete.php?id=<?php echo $show['Department_ID']; ?>"><button class="btn btn-danger"><i class="fas fa-trash"></i></button></a>
                    </td>
                  </tr>
                  <?php $a++; } } ?>
                </tbody>
