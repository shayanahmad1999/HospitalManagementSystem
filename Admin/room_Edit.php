        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" action="Room/update.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="form-group">
                    <label>Name</label>
                    <input type="text" name="room_type" value="<?php echo $edit['room_type']; ?>" class="form-control" placeholder="Your Name">
            </div>
            <!-- /.card-body -->
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary">Update</button>
                  <input type="hidden" name="room" value="update">
                  <input type="hidden" name="update" value="<?php echo $edit['room_id']; ?>">
                </div>
              </form>
            </div>
            <!-- /.card -->
